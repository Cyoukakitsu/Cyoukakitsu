...
| [XDigest](https://github.com/Cyoukakitsu/XDigest) | React, Vite, Tailwind CSS, Zustand, FastAPI, twikit, OpenRouter, Gmail SMTP | Automated X (Twitter) post aggregator with AI-powered summaries, delivered daily via scheduled email digests |
